        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-24 mb-12 md:mb-16">
          ...
          <div className="flex flex-col gap-6">
            ...
            <p className="text-neutral-400 text-base md:text-lg max-w-md leading-relaxed font-light">
              Nagra Toli, Near Raam Pyaari Hospital, SN Yadav Road, Ranchi. The premier destination for athletes who demand results.
            </p>
            ...
            <div className="flex gap-4 mt-4">
              ...
              {/* Instagram */}
              <a href="https://www.instagram.com/the_a2_gym" target="_blank" rel="noopener noreferrer" className="group relative h-10 w-10 rounded-full border border-white/10 flex items-center justify-center hover:border-primary hover:bg-primary transition-all duration-300">
